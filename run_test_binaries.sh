...
for i in \
    ...
    ./test-binaries/strlen-open-posix-testsuite-1-1 ./test-binaries/strlen-NetBSD-t ./test-binaries/strlen-arm-optimized-routines ./test-binaries/strlen-reactos-crt
do
