...
for i in \
    ...
    ./test-binaries/strcat-llvm-project-strcat_test ./test-binaries/strcat-gcc-strcat ./test-binaries/strcat-cc65-lib_common_strcat ./test-binaries/strcat-scc-0011-strcat
do
