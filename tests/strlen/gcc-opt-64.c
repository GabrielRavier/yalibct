...
YALIBCT_ATTRIBUTE_NOCLONE __attribute__ ((noinline)) YALIBCT_ATTRIBUTE_NOIPA
...
void deref_idx_1 (void)
{
  ...
  A (strlen ((const char *)*p[0]) == 0);
}

YALIBCT_ATTRIBUTE_NOCLONE __attribute__ ((noinline)) YALIBCT_ATTRIBUTE_NOIPA
void deref_idx_2 (void)
{
  strcpy ((char *)*p[2], "1234");
  A (strlen ((char *)*p[2]) == 4);
  A (strlen ((char *)&(*p[2])[1]) == 2);
  A (strlen ((char *)&(*p[2])[2]) == 0);
...
{
  strcpy ((char *)*p[3], "123456");
  A (strlen ((char *)*p[3]) == 6);
  A (strlen ((char *)&(*p[3])[1]) == 4);
  A (strlen ((char *)&(*p[3])[2]) == 2);
  A (strlen ((char *)&(*p[3])[3]) == 0);
...
{
  strcpy ((char *)*p[4], "12345678");
  A (strlen ((char *)*p[4]) == 8);
  A (strlen ((char *)&(*p[4])[1]) == 6);
  A (strlen ((char *)&(*p[4])[2]) == 4);
  A (strlen ((char *)&(*p[4])[3]) == 2);
  A (strlen ((char *)&(*p[4])[4]) == 0);
