...
#if !defined(NO_FLOAT) && !defined(YALIBCT_DISABLE_PRINTF_E_CONVERSION_SPECIFIER_TESTS)
...
#endif
#if !defined(NO_FLOAT) && !defined(YALIBCT_DISABLE_PRINTF_G_CONVERSION_SPECIFIER_TESTS)
...
#ifdef _WANT_IO_C99_FORMATS
{
...
#endif
#if !defined(NO_FLOAT) && !defined(YALIBCT_DISABLE_PRINTF_A_CONVERSION_SPECIFIER_TESTS)
    ...
    result |= test2(__LINE__, "0x0.0000000000001p-1022", "0x1p-1074", "%a", 0x1p-1074);
#endif
