...
MODE=dbg CC='/home/gravier/src/libraries/programming/languages-implementations/standard-libraries/c/implementations/cosmopolitan-libc/.cosmocc/3.8.0/bin/cosmocc' \
    cmake \
        ...
        -DYALIBCT_DISABLE_PRINTF_A_CONVERSION_SPECIFIER_TESTS=ON `# See https://github.com/jart/cosmopolitan/pull/1286, https://github.com/jart/cosmopolitan/pull/1287, https://github.com/jart/cosmopolitan/pull/1296, https://github.com/jart/cosmopolitan/pull/1297` \
        ...
        -DYALIBCT_LIBC_DOESNT_HAVE_FCVT=ON `# See https://github.com/jart/cosmopolitan/pull/1282` \
        -DYALIBCT_LIBC_DOESNT_HAVE_ECVT=ON `# See https://github.com/jart/cosmopolitan/pull/1282` \
