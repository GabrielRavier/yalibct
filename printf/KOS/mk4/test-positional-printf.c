...
DEFINE_TEST(positional_printf) {
	 ...
	 *  - "%.*16$..." -- set:precision=positional[16].uint; */
        // The commented out cases are commented out because basically only KOS supports writing precision and width in any order
	...
	// Note: disabled because pretty much nobody has %q
